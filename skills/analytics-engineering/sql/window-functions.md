...
SQL style throughout these docs follows [effective-sql](effective-sql.md): lowercase keywords, CTE pipelines (import → transform → output), explicit `as` aliases, descriptive column names with type/unit suffixes.
