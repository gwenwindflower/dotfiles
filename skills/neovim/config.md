...
LazyVim provides the base configuration for Neovim on this system, which is then customized to the user's needs and preferences. This doc works from this point of view, not a vanilla Neovim setup.
