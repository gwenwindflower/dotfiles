...
Create `tests/run.lua` to bootstrap rtp, luarocks paths, and invoke busted. Run with `nvim -l tests/run.lua`. For the full runner template and Neovim-specific testing patterns, see [plugin-testing-with-busted](plugin-testing-with-busted.md).
