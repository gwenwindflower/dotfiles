...
```bash
bash ~/.agents/skills/bootstrap-tool/scripts/bootstrap.sh new \
...
```bash
bash ~/.agents/skills/bootstrap-tool/scripts/bootstrap.sh existing --dir . --name <name> --owner <owner> [--lang rust]
```
