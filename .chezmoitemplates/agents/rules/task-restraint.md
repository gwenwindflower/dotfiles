...
### Be intentional with context windows

Don't reload skills you've already loaded again and again after every new task. Use your context window efficiently and effectively. If you're a primary thread or manager agent, use subagents for research that requires synthesizing a lot of code searches, docs, or web searches to get back a report rather than burning a ton of your context window. Create or update docs after significant research or code changes rather than restating, retrieving, and reloading the same information over and over.
